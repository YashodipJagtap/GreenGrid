            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 py-16">
                <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg p-7">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full bg-green-600 hover:bg-green-700 text-white py-3 px-5 rounded-lg font-medium transition-colors duration-200 shadow-md hover:shadow-lg disabled:opacity-70"
                    >
                        {loading ? (
