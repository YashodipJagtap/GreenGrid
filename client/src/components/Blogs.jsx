                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12 mb-8">
                        ...
                        <div className="flex items-center mb-4">
                            <img className="w-10 h-10 rounded-full mr-3" src={author1} alt="Sarah Johnson" />
                            <div>
                                <p className="text-sm font-medium text-gray-900">Sarah Johnson</p>
                                <p className="text-sm text-gray-500">Mar 15, 2025 · 8 min read</p>
                            </div>
                        </div>

                        <p className="text-lg font-normal text-gray-500 mb-4">Laptops and computers have become a necessity in the digital age. On the other hand, laptop production, utilization, and disposal contribute to carbon emissions and environmental degradation.
                        ...
                        <div className="mt-6 flex items-center justify-between border-t border-gray-200 pt-4">
                            <div className="flex items-center space-x-4">
                                ...
                                >
                                    ...
                                    <span>{getComments(1).length}</span>
                                </button>
                                ...
                                <div className="relative">
                                    ...
                                    {shareOptionsVisible && (
                                        <div className="absolute z-10 left-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1">
                                            <button onClick={() => handleSharePost('Twitter', 1)} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">Twitter</button>
                                            <button onClick={() => handleSharePost('Facebook', 1)} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">Facebook</button>
                                            <button onClick={() => handleSharePost('LinkedIn', 1)} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">LinkedIn</button>
                                            <button onClick={() => handleSharePost('Email', 1)} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">Email</button>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        {activeBlog === 1 && (
                            <div className="mt-6 border-t border-gray-200 pt-4">
                                <h3 className="text-xl font-semibold mb-4">Comments ({getComments(1).length})</h3>
                                ...
                                <div className="mb-4">
                                    {getComments(1).map((comment, index) => (
                                        <div key={index} className="mb-4 pb-4 border-b border-gray-100">
                                            <div className="flex items-start">
                                                ...
                                                <button className="text-gray-400 hover:text-green-600">Reply</button>
                                            </div>
                                        </div>
                                    ))}
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <textarea
                                            className="w-full px-3 py-2 text-gray-700 border rounded-lg focus:outline-none focus:ring-1 focus:ring-green-600"
                                            rows="4"
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-8">
                        {[1, 2, 3].map((blogId) => (
                            <div key={blogId} className="h-full bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
                                <img className="lg:h-48 md:h-36 w-full object-cover object-center" src={blogId === 1 ? blog1 : blogId === 2 ? blog3 : blog2} alt="blog" />
                                <div className="p-8 md:p-12">
                                    ...
                                    {/* Author and Date Info */}
                                    <div className="flex items-center mb-4">
                                        <img className="w-8 h-8 rounded-full mr-2" src={blogId === 1 ? author2 : blogId === 2 ? author3 : author1} alt="Author" />
                                        <div>
                                    ...
                                    <div className="mt-4 flex items-center space-x-4 text-sm">
                                        ...
                                        <button
                                            ...
                                            className="flex items-center text-gray-500 hover:text-green-600"
                                        >
                                            <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.org/2000/svg">
                                                <path d="M15 8a3 3 0 10-2.977-2.63l-4.94 2.47a3 3 0 100 4.319l4.94 2.47a3 3 0 10.895-1.789l-4.94-2.47a3.027 3.027 0 000-.74l4.94-2.47C13.456 7.68 14.19 8 15 8z" />
                                            </svg>
                                            <span>Share</span>
                                        </button>
                                    ...
                                    {/* Read More Link */}
                                    <div className="mt-4">
                                        <button onClick={scrollToTop} className="text-green-600 hover:text-green-800 font-medium">
                                            Read more →
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-8">
                        {[4, 5].map((blogId) => (
                            <div key={blogId} className="h-full bg-gray-50 border border-gray-200 rounded-lg p-8 md:p-12">
                                <div className="flex justify-between items-start mb-2">
                                    <h2 className="text-gray-900 text-3xl font-bold">
                                ...
                                {/* Author and Date Info */}
                                <div className="flex items-center mb-4">
                                    <img className="w-8 h-8 rounded-full mr-2" src={blogId === 4 ? author3 : author2} alt="Author" />
                                    <div>
                                        <p className="text-xs font-medium text-gray-900">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        <div className="md:col-span-3">
                            {/* Related Posts */}
                            <div className="mb-8">
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">Related Posts</h3>
                                    ...
                                    {relatedPosts.map((post) => (
                                        <div key={post.id} className="bg-gray-50 rounded-lg overflow-hidden shadow-sm border border-gray-200">
                                            ...
                                            <div className="p-4">
                                                ...
                                                <button onClick={scrollToTop} className="mt-2 inline-block text-green-600 hover:text-green-800 text-sm font-medium">
                                                    Read more →
                                                </button>
                                            </div>
                                        </div>
                            ...
                            {/* Popular Tags */}
                            <div className="mb-8">
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">Popular Tags</h3>
                                <div className="flex flex-wrap gap-2">
                                    {tags.map((tag, index) => (
                                        <button key={index} onClick={scrollToTop} className="px-3 py-1 bg-gray-100 text-gray-800 text-sm rounded-full hover:bg-green-100 hover:text-green-800">
                                            #{tag}
                                        </button>
                                    ))}
                                </div>
                        ...
                        <div className="md:col-span-1">
                            ...
                            <div className="bg-gray-50 rounded-lg p-6 mb-6 shadow-sm border border-gray-200">
                                ...
                                <ul className="space-y-2">
                                    {categories.map((category, index) => (
                                        <li key={index}>
                                            <button onClick={scrollToTop} className="flex justify-between text-gray-600 hover:text-green-600 w-full text-left">
                            ...
                            {/* Archives */}
                            <div className="bg-gray-50 rounded-lg p-6 mb-6 shadow-sm border border-gray-200">
                                <h3 className="text-xl font-bold text-gray-900 mb-3">Archives</h3>
                                <ul className="space-y-2">
