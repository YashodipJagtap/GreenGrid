...
const Footer = () => {
    return (
        <footer className="text-gray-600 body-font border-t border-gray-200">
            <div className="container px-6 py-6 mx-auto flex items-center justify-between flex-wrap">
                ...
                {/* Center: Copyright */}
                <p className="text-base text-gray-700 text-center w-full sm:w-auto my-2 sm:my-0">
                    © 2025 <span className="font-medium">Green Grid</span> | Designed & Developed by{" "}
                    <span className="font-medium">Yashodip Jagtap</span> | All Rights Reserved
                </p>

                {/* Right: Social Icons */}
                <span className="inline-flex justify-center sm:justify-end">
                    <a
