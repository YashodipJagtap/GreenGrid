                    ...
                    <div className="flex flex-wrap -m-4 text-center">
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                ...
                                <p className="mt-4 text-sm leading-relaxed">E-Waste generated by a single person.</p>
                            </div>
                        </div>
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                ...
                                <p className="mt-4 text-sm leading-relaxed">E-waste generated World Wide</p>
                            </div>
                        </div>
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                ...
                                <p className="mt-4 text-sm leading-relaxed">E-Recycler in India</p>
                            </div>
                        </div>
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                                ...
                                <p className="mt-4 text-sm leading-relaxed">of E-Waste is collected only.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="flex flex-col sm:flex-row mt-10">
                            <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                                <div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
                                    <img src={MOE_Logo} alt="MOE_Logo" className="w-full h-full object-contain" />
                                </div>
                ...
                <div className="container px-5 mx-auto">
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full px-4">
                            <div className="mx-auto mb-16 max-w-[510px] text-center">
                                <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl md:text-[40px]">
                                    Our Blogs
                                </h2>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div className="mx-auto mb-10 max-w-[370px]">
                                <div className="mb-8 overflow-hidden rounded">
                                    <img src={blog1} alt="" className="w-full h-48 object-cover" />
                                </div>
                                <div>
                                    <h3>
                                        <a
                        ...
                        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div className="mx-auto mb-10 max-w-[370px]">
                                <div className="mb-8 overflow-hidden rounded">
                                    <img src={blog2} alt="" className="w-full h-48 object-cover" />
                                </div>
                                <div>
                                    <h3>
                                        <a
                        ...
                        <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                            <div className="mx-auto mb-10 max-w-[370px]">
                                <div className="mb-8 overflow-hidden rounded">
                                    <img src={blog3} alt="" className="w-full h-48 object-cover" />
                                </div>
                                <div>
                                    <h3>
                                        <a
